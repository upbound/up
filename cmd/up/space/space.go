...
type Cmd struct {
	Attach  attachCmd  `cmd:"" help:"Connect an Upbound Space to the Upbound web console."`
	Detach  detachCmd  `cmd:"" help:"Detach an Upbound Space from the Upbound web console."`
